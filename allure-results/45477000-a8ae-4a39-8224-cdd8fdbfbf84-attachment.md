...
Expected value: "Michal"
Received value: {"booking": {"additionalneeds": "Breakfast", "bookingdates": {"checkin": "2023-08-24", "checkout": "2023-08-29"}, "depositpaid": true, "firstname": "Michal", "lastname": "Brown", "totalprice": 222}, "bookingid": 827}
```
...
> 46 |         expect(responseBody).toHaveProperty('firstname', 'Michal');
     |                              ^ Error: expect(received).toHaveProperty(path, value)
  47 |         expect(responseBody).toHaveProperty('lastname', 'Drajna');
  48 |         expect(responseBody).toHaveProperty('total', 'Drajna');
  49 | 
  50 |     });
  51 | 
  52 | });
